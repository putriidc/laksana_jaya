...
class ProyekMdOwnerController extends Controller
{
   public function index()
    ...
    public function create()
    {
        ...
        return view('owner.master-data.form-add.proyek', compact('pic'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('master-data-owner.index')->with('success', 'Proyek berhasil ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        $pic = Karyawan::active()->get();
        return view('owner.master-data.form-edit.proyek', compact('proyek', 'pic'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('master-data-owner.index')->with('success', 'Proyek berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('master-data-owner.index')->with('success', 'Proyek berhasil dihapus (soft delete)');
    }
}
