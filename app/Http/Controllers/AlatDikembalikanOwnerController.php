...
class AlatDikembalikanOwnerController extends Controller
{
    public function createForAlat($kode_alat)
    {
        ...
        $alatdipinjams = AlatDipinjam::where('kode_alat', $alats->kode_alat)->whereNull('deleted_at')->get();
         ...
         return view('owner.data-alat.alatDikembalikan.create', compact('alats', 'today', 'proyeks', 'alatdipinjams'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('alatsOwner.show', $alat->id)->with('success', 'Stok Alat berhasil dikembalikan');
    }
    ...
    public function edit($id)
    {
        ...
        $alatDipinjams = AlatDipinjam::where('kode_alat', $alats->kode_alat)
                        ->whereNull('deleted_at')
                        ->get();
        return view('owner.data-alat.alatDikembalikan.edit', compact('alatDikembalikans', 'alats', 'proyeks', 'alatDipinjams', 'proyekDikembalikan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('alatsOwner.show', $alat->id)->with('success', 'Stok Alat Dikembalikan berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('alatsOwner.show', $alat->id)->with('success', 'Stok Alat Dikembalikan berhasil dihapus');
    }
}
