...
class AlatDibeliController extends Controller
{
    /**
    ...
    public function create($kode_alat)
    {
        ...
        return view('kepala-gudang.data-alat.alatDibeli.create', compact('alat'));
    }
    ...
    public function createForAlat($kode_alat)
    {
        ...
        $today = Carbon::now('Asia/Jakarta')->toDateString();
         ...
         return view('kepala-gudang.data-alat.alatDibeli.create', compact('alats', 'today'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('kepala-gudang.data-alat.alatDibeli.edit', compact('alatMasuk', 'alats'));
    }
