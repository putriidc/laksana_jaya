...
class BarangKeluarOwnerController extends Controller
{
    public function index()
    {
        ...
        // return view('owner.transaksi-barang.data', compact('barangKeluars', 'barangMasuks'));
    }
    ...
    public function create()
    {
        ...
        return view('owner.transaksi-barang.create-keluar', compact('barangs'));
    }
    public function createForBarang($kode_barang)
    {
        ...
        return view('owner.detail-barang.transaksi-barang.create-keluar', compact('barang', 'today', 'proyeks'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($barang->stok < $request->qty) {
            ...
            return redirect()->route('barangsOwner.show', $barang->id)->with('success', 'Barang berhasil dikurangkan');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('owner.detail-barang.transaksi-barang.edit-keluar', compact('barangMasuk', 'proyeks', 'barangs', 'proyekKeluar'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('barangsOwner.show', $barang->id)->with('success', 'Data barang keluar berhasil diupdate');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('barangsOwner.show', $barang->id)->with('success', 'Stok Barang Keluar berhasil dihapus');
    }
}
