...
class AlatOwnerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('owner.data-alat.data', compact('alats'));
    }
    ...
    public function print(Request $request)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.print', compact('alats', 'jamCetak', 'tanggalCetak'))
    ...
    {
        return view('owner.data-alat.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('alatsOwner.index')->with('success', 'Alat berhasil ditambahkan');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('owner.data-alat.detail', compact(
            'alat',
            'alatDibelis',
            'alatDipinjams',
            'alatDikembalikans',
    ...
    public function printDibeli(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.alatDibeli.print', compact('alat', 'jamCetak', 'alatDibelis', 'spv', 'role', 'tanggalCetak'))
            ->setPaper('A4', 'portrait');
    ...
    public function printDetailBeli(request $request)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.printDetailBeli', compact('tanggal', 'qty', 'keterangan', 'admin', 'role', 'tanggalCetak', 'jamCetak'))
            ->setPaper('A4', 'potrait');
    ...
    public function printDihapus(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.alatDihapus.print', compact('alat', 'jamCetak', 'alatDihapus', 'admin', 'role', 'tanggalCetak'))
            ->setPaper('A4', 'portrait');
    ...
    public function printDetailHapus(request $request)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.printDetailHapus', compact('tanggal', 'qty', 'keterangan', 'admin', 'role', 'tanggalCetak', 'jamCetak'))
            ->setPaper('A4', 'potrait');
    ...
    public function printDikembalikan(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.alatDikembalikan.print', compact('alat', 'jamCetak', 'proyeks', 'alatDikembalikans', 'admin', 'role', 'tanggalCetak'))
            ->setPaper('A4', 'portrait');
    ...
    public function printDetailKembali(request $request)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.printDetailKembali', compact('tanggal', 'proyek', 'pic', 'qty', 'keterangan', 'admin', 'role', 'tanggalCetak', 'jamCetak'))
            ->setPaper('A4', 'potrait');
    ...
    public function printDipinjam(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.alatDipinjam.print', compact('alat', 'proyeks', 'jamCetak',  'alatDipinjams', 'admin', 'role', 'tanggalCetak'))
            ->setPaper('A4', 'portrait');
    ...
    public function printDetailPinjam(request $request)
    {
        ...
        $pdf = Pdf::loadView('owner.data-alat.printDetailPinjam', compact('tanggal', 'proyek', 'pic', 'qty', 'keterangan', 'admin', 'role', 'tanggalCetak', 'jamCetak'))
            ->setPaper('A4', 'potrait');
    ...
    {
        $alat = Alat::findOrFail($id);
        return view('owner.data-alat.edit', compact('alat'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('alatsOwner.index')->with('success', 'alat berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('alatsOwner.index')->with('success', 'alat berhasil dihapus');
    }
}
