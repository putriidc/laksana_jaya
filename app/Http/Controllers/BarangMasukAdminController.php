...
class BarangMasukAdminController extends Controller
{
    ...
    public function createForBarang($kode_barang)
    {
        ...
        return view('admin.detail-barang.transaksi-barang.create-masuk', compact('barang', 'today'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('barangsAdmin.show', $barang->id)->with('success', 'Barang masuk berhasil ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.detail-barang.transaksi-barang.edit-masuk', compact('barangMasuk', 'barangs'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('barangsAdmin.show', $barang->id)->with('success', 'Data barang masuk berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('barangsAdmin.show', $barang->id)->with('success', 'Barang masuk berhasil dihapus');
    }
}
