...
class BarangKeluarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('barang-masuk.index')->with('success', 'Barang berhasil dikurangkan');
    }
    ...
    public function edit($id)
    {
        ...
        $barangs = Barang::whereNull('deleted_at')->get();
        return view('kepala-gudang.transaksi-barang.edit-keluar', compact('barangMasuk', 'barangs'));
    }
