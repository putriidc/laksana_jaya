...
class AlatDipinjamController extends Controller
{
    ...
    public function createForAlat($kode_alat)
    {
        ...
        $proyeks = Proyek::whereNull('deleted_at')->get();
         ...
         return view('kepala-gudang.data-alat.alatDipinjam.create', compact('alats', 'today', 'proyeks'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('kepala-gudang.data-alat.alatDipinjam.edit', compact('alatPinjam', 'alats', 'proyeks' , 'proyekDipinjam'));
    }
