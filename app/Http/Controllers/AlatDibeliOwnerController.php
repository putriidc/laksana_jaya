...
class AlatDibeliOwnerController extends Controller
{
    ...
    public function createForAlat($kode_alat)
    {
        ...
        $today = Carbon::now('Asia/Jakarta')->toDateString();
         ...
         return view('owner.data-alat.alatDibeli.create', compact('alats', 'today'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('alatsOwner.show', $alat->id)->with('success', 'Stok Alat berhasil ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('owner.data-alat.alatDibeli.edit', compact('alatMasuk', 'alats'));
    }
