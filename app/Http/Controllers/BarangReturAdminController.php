...
class BarangReturAdminController extends Controller
{
    public function create($kode_barang)
    {
        ...
        return view('admin.detail-barang.transaksi-barang.create-masuk', compact('barang'));
    }
    ...
    public function createForBarang($kode_barang)
    {
        ...
        return view('admin.detail-barang.transaksi-barang.create-retur', compact('barang', 'today', 'proyeks'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('barangsAdmin.show', $barang->id)->with('success', 'Barang retur berhasil ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.detail-barang.transaksi-barang.edit-retur', compact('barangMasuk', 'barangs', 'proyeks', 'proyekRetur'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('barangsAdmin.show', $barang->id)->with('success', 'Data barang retur berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('barangsAdmin.show', $barang->id)->with('success', 'Barang retur berhasil dihapus');
    }
}
