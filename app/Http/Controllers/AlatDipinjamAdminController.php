...
class AlatDipinjamAdminController extends Controller
{
    /**
    ...
    public function createForAlat($kode_alat)
    {
        ...
        $proyeks = Proyek::whereNull('deleted_at')->get();
         ...
         return view('admin.data-alat.alatDipinjam.create', compact('alats', 'today', 'proyeks'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($alat->stok < $request->qty) {
            return redirect()->route('alatsAdmin.show', $alat->id)->with('error', 'Total stok yang tersedia tidak cukup');
        } else {
            ...
            return redirect()->route('alatsAdmin.show', $alat->id)->with('success', 'Stok Alat berhasil dipinjam');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.data-alat.alatDipinjam.edit', compact('alatPinjam', 'alats', 'proyeks' , 'proyekDipinjam'));
    }
