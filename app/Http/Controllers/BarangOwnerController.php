...
class BarangOwnerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('owner.data-barang.data', compact('barangs'));
    }
    ...
    public function print(Request $request) {
        ...
        $pdf = Pdf::loadView('owner.data-barang.print', compact('barangs', 'jamCetak', 'tanggalCetak'))
    ...
    {
        return view('owner.data-barang.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('barangsOwner.index')->with('success', 'Barang berhasil ditambahkan');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('owner.detail-barang.index', compact(
            'barang',
            'proyeks',
            'catatStok',
            'barangMasuks',
    ...
    public function printMasuk(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadView('owner.detail-barang.printIn', compact('barang', 'proyeks', 'jamCetak', 'barangMasuks', 'admin', 'role', 'tanggalCetak'))
            ->setPaper('A4', 'portrait');
    ...
    public function printKeluar(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadView('owner.detail-barang.printOut', compact('barang', 'proyeks', 'jamCetak', 'barangKeluars', 'admin', 'role', 'tanggalCetak'))
            ->setPaper('A4', 'portrait');
    ...
    public function printRetur(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadView('owner.detail-barang.printRtr', compact('barang', 'proyeks', 'jamCetak', 'barangReturs', 'admin', 'role', 'tanggalCetak'))
            ->setPaper('A4', 'portrait');
    ...
    {
        $barang = Barang::findOrFail($id);
        return view('owner.data-barang.edit', compact('barang'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('barangsOwner.index')->with('success', 'Barang berhasil diupdate');
    }
