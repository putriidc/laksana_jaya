...
class AlatDihapusOwnerController extends Controller
{
     public function createForAlat($kode_alat)
    {
        ...
        $today = Carbon::now('Asia/Jakarta')->toDateString();
         ...
         return view('owner.data-alat.alatDihapus.create', compact('alats', 'today'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($alat->stok < $request->qty) {
            ...
            return redirect()->route('alatsOwner.show', $alat->id)->with('error', 'Total Stok Alat yang dikeluarkan lebih besar dari stok yang tersedia');
        } else {
            // Simpan barang masuk
            ...
            return redirect()->route('alatsOwner.show', $alat->id)->with('success', 'Stok Alat yang dihapus berhasil ditambahkan');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('owner.data-alat.alatDihapus.edit', compact('alatMasuk', 'alats'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (($alat->stok + $alatMasuk->qty) < $request->qty) {
            ...
            return redirect()->route('alatsOwner.show', $alat->id)->with('success', 'Stok Alat yang dihapus berhasil diupdate');
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('alatsOwner.show', $alat->id)->with('success', 'Stok Alat yang dihapus berhasil didelete dari data');
    }
}
