...
class SampinganController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sampingans.index')->with('success', 'Data sampingan berhasil ditambahkan');
    }
    ...
    public function show($id)
    {
        ...
        return view('sampingan.show', compact('sampingan'));
    }

    public function edit($id)
    {
        $sampingan = Sampingan::findOrFail($id);
        return view('admin.freelance.form-edit.index', compact('sampingan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('sampingans.index')->with('success', 'Data sampingan berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('sampingans.index')->with('success', 'Data berhasil dihapus');
    }
}
