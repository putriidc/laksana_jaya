...
class AssetOwnerController extends Controller
{
    public function index()
    {
        ...
        return view('owner.master-data.data', compact('assets'));
    }

    public function create()
    {
        return view('owner.master-data.form-add.asset');
    }
     ...
     public function store(Request $request)
    {
        ...
        return redirect()->route('master-data-owner.index')->with('success', 'Data akun berhasil disimpan');
    }

    public function edit($id)
    {
        $akun = Asset::findOrFail($id);
        return view('owner.master-data.form-edit.asset', compact('akun'));
    }
     ...
     public function update(Request $request, $id)
    {
        ...
        return redirect()->route('master-data-owner.index')->with('success', 'Data akun berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('master-data-owner.index')->with('success', 'Asset berhasil dihapus (soft delete)');
    }
}
