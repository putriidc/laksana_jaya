            ...
            >
                ...
                <div class="flex flex-col gap-y-3 h-full">
                        ...
                        >
                            ...
                            <img src="{{ asset('assets/arrow-down-white.png') }}" alt="arrow down icon" id="arrow-navbar" class="transition-all duration-300 ease-in-out" />
                            <input type="checkbox" id="dropdown-toggle-navbar" class="hidden" />
                        </label>
                        <div class="flex flex-col gap-y-3 -translate-y-[60px] transition-all duration-300 ease-in-out" id="dropdown-content">
                            ...
                            <a href="/kepala-proyek/data-proyek-purnama" class="cursor-pointer -translate-y-[60px] transition-all duration-300 ease-in-out" id="inside-content">
                                <button
                                    class="bg-white text-[#353132] flex items-center justify-center w-[250px] py-3 px-5 cursor-pointer link-clicked"
                                >
                    ...
                    <a href="/kepala-proyek/data-proyek/create" class="cursor-pointer -translate-y-[120px] transition-all duration-300 ease-in-out outside-content">
                        <button
