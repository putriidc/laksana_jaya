...
@section('content')
    <div>
        <h1 class="font-bold text-2xl mb-4">Update Data Proyek</h1>
            ...
            <form action="" method="post" class="flex flex-col w-full gap-y-5">
                ...
                <div class="flex items-center gap-x-5">
                    ...
                    <div class="w-full flex justify-between">
                        <button class="border-[#45D03E] border py-1 px-2 rounded-lg flex items-center justify-center cursor-pointer" id="add-input">
                            <span class="text-[#45D03E]">Tambah Data</span>
                            <img src="{{ asset('assets/plus-circle-green.png') }}" alt="plus circle green icon" class="inline-block ml-2" />
                        </button>
