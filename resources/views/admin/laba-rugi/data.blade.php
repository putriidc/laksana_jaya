...
<div>
    ...
    <form action="" method="post" class="flex items-center gap-x-2 mb-5">
        @csrf
        <input type="text" data-flatpickr name="" id="" class="border-2 border-[#9A9A9A] px-4 py-2 rounded-lg w-[200px]" placeholder="Pilih Tanggal">
        ...
        <a href="" class="py-[10px] px-[10px] border-[#9A9A9A] border-2 rounded-lg cursor-pointer flex items-center gap-x-2">
