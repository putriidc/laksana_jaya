        ...
        <section class="w-full py-8 px-14 rounded-2xl shadow-[0px_0px_5px_rgba(0,0,0,0.25)] gap-y-4 flex flex-col">
            <div class="flex flex-col gap-y-1">
                ...
                @foreach ($pendapatanFinal as $item)
                    <div class="text-[#9A9A9A] flex items-center justify-between">
                        <span class="">{{ $item['nama_perkiraan'] }}</span>
                        <span class=" mr-20 w-[200px]">Rp. {{ number_format($item['total'], 0, ',', '.') }}</span>
                    </div>
                @endforeach
                {{-- <div class="text-[#9A9A9A] flex items-center justify-between">
            ...
            <div class="flex flex-col gap-y-1">
                <div class="text-[#9A9A9A] flex items-center justify-between">
                    ...
                    <span class="font-bold">Rp. {{ number_format($totalBiaya, 0, ',', '.') }}</span>
                </div>
            ...
            <div class="flex flex-col gap-y-1">
                <div class="text-[#9A9A9A] flex items-center justify-between">
                    ...
                    <span class="font-bold">Rp. {{ number_format($totalLabaRugi, 0, ',', '.') }}</span>
                </div>
            </div>
        </section>
    </div>
