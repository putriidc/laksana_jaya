...
<div class="flex flex-col items-center">
    ...
    <div class="shadow-[0px_0px_15px_rgba(0,0,0,0.25)] w-full p-10 rounded-lg bg-white">
        <form method="POST" action="{{ route('pinjamanContents.storeBayar') }}" class="flex flex-col gap-y-4" id="myForm">
            @csrf
            ...
            <div class="flex items-center max-[500px]:flex-col max-[500px]:items-start max-[500px]:gap-y-2">
                    <label for="" class="w-[240px] font-medium">Kas / Bank</label>
            ...
            <div class="flex mt-4">
                <div class="w-[240px] max-[500px]:hidden"></div>
