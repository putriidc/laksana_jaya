...
<head>
    <meta charset="UTF-8">
    <title>Detail Hutang Vendor</title>
    <style>
        @page { margin: 0.5cm; }
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h2 style="margin-top: 10px; text-transform: uppercase">hutang vendor</h2>
    </div>
    <div class="container">
        <table>
            <tr>
                <td class="label">Tanggal Hutang</td>
                <td><div class="input-mock">{{ $tgl_hutang }}</div></td>
            </tr>
            <tr>
                <td class="label">Nama Supplier</td>
                <td><div class="input-mock">{{ $supplier }}</div></td>
            </tr>
            <tr>
                <td class="label">Tanggal Jatuh Tempo</td>
                <td><div class="input-mock">{{ $tgl_jatuh_tempo }}</div></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><div class="input-mock">{{ $status }}</div></td>
            </tr>
