            ...
            <div class="flex items-center pb-4 justify-between">
                ...
                <div class="flex items-center gap-x-2">
                    <a target="_blank" href=""
                        class="flex items-center gap-x-2 border-[#9A9A9A] border-2 rounded-lg px-4 py-2"><span class="text-gray-600">Cetak Semua Data</span> <img src="{{ asset('assets/printer.png') }}" alt="" class="w-[25px]"></a>
                    <button
                        class="block border-[#45D03E] text-[#45D03E] border-2 rounded-lg px-4 py-2 cursor-pointer" onclick="tambahData()">Tambah
                        Data +</button>
                    </div>
            </div>
                ...
                <table class="table-fixed text-center text-sm w-full">
                    ...
                    <tbody>
                            <tr class="bg-[#E9E9E9] border-b-[1px] border-[#CCCCCC]">
                                <td class="py-2">1</td>
                                <td class="py-2">TB. Ferri</td>
                                <td class="py-2">Pasir, Besi, dll</td>
                                <td class="py-2">Rp. 5.000.000</td>
                                <td class="py-2">Proyek Pak Dwi</td>
                                <td class="py-2">12/01/2026</td>
                                <td class="flex justify-center items-center gap-x-2 py-2">
                                    {{-- Tombol Edit --}}
                                    <button class="btn btn-sm btn-primary" onclick="editData()">
                                        <img src="{{ asset('assets/edit-icon.png') }}" alt="edit icon"
                                            class="w-[22px] cursor-pointer">
                                    </button>
                                    <span class="border-black border-l-[1px] h-[22px]"></span>
                                    <button class="btn btn-sm btn-primary" onclick="detailData()">
            ...
            function tambahData() {
                ...
                Swal.fire({
                    ...
                    <div class="flex items-center w-full">
                        ...
                        <select type="date" class="w-full outline-none bg-[#D9D9D9] rounded-lg px-4 py-2 cursor-pointer appearance-none" name="" id="">
                    ...
                    <div class="flex items-center w-full">
                        ...
                        <input type="date" class="w-full outline-none bg-[#D9D9D9] rounded-lg px-4 py-2 cursor-pointer" name="" id=""/>
                    </div>
                    <div class="flex items-center w-full">
                        <label class="w-[200px] text-start">
                            Nominal
                        </label>
                        <input type="text" class="w-full outline-none bg-[#D9D9D9] rounded-lg px-4 py-2 cursor-pointer rupiah-format" name="" id=""/>
                    </div>
                    <div class="flex items-center w-full">
                        <label class="w-[200px] text-start">
                            Nama Proyek
                    ...
                    <div class="flex items-center w-full">
                        ...
                        <input type="text" class="w-full outline-none bg-[#D9D9D9] rounded-lg px-4 py-2 cursor-pointer" name="" id=""/>
                    </div>
                    <div class="flex items-center w-full">
                        <label class="w-[150px] text-start">
                        </label>
                        <button class="flex items-center gap-x-2 py-1 px-4 rounded-lg border border-[#3E98D0] cursor-pointer mr-2">
