...
<body class="font-poppins">
    <section class="flex h-screen">
        <nav class="flex flex-col bg-white h-screen w-[300px] py-5 px-5 shadow-[1px_0px_5px_rgba(0,0,0,0.25)] items-center relative z-[99]">
            {{-- Logo --}}
            ...
            <div class="flex flex-col gap-y-3 h-full">
                <a href="/admin/dashboard" class="cursor-pointer">
                    <button class="bg-linear-to-r from-[#DD4049] to-[#F9E52D] text-white flex items-center gap-x-5 w-[250px] py-3 px-5 rounded-lg cursor-pointer shadow-[1px_1px_5px_rgba(0,0,0,0.25)]">
                ...
                <a href="{{ route('jurnalUmums.index') }}" class="cursor-pointer">
                    <button class="bg-white text-[#353132] flex items-center gap-x-5 w-[250px] py-3 px-5 rounded-lg cursor-pointer shadow-[1px_1px_5px_rgba(0,0,0,0.25)]">
        ...
        <div class="w-full flex flex-col relative">
            ...
            <footer class="absolute bottom-0 z-50 flex justify-center w-full py-3 shadow-[0px_-1px_5px_rgba(0,0,0,0.25)] bg-white">
