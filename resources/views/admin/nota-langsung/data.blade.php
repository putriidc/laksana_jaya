                ...
                Swal.fire({
                    html: `
                            <form action="" method="POST" class="flex flex-col gap-y-4">
                                ...
                                <div class="flex items-center">
                                    <label for="pic" class="font-medium w-[150px]">PIC</label>
