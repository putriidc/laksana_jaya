...
<div class="flex flex-col items-center">
    <h1 class="text-2xl font-bold mb-4 w-full">Data Karyawan</h1>
    <div class="shadow-[0px_0px_15px_rgba(0,0,0,0.25)] w-full p-10 rounded-lg bg-white">
        <form action="" class="flex flex-col gap-y-4">
            <div class="flex items-center">
                ...
                <input type="text" name="" id="" value="k-karyawan 0025" class="w-full outline-none bg-[#D9D9D9]/40 rounded-sm px-4 py-2" readonly>
            </div>
            <div class="flex items-center">
                <label for="" class="w-[180px] font-medium">Nama PIC</label>
            ...
            <div class="flex items-center">
               ...
               <input type="text" name="" id="" class="w-full outline-none bg-[#D9D9D9]/40 rounded-sm px-4 py-2" value="Piutang Usaha">
            </div>
            <div class="flex items-center">
