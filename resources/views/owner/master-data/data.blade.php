        ...
        <section class="flex flex-col">
                ...
                <div class="flex items-center gap-x-2">
                    ...
                    {{-- <label for="dropdown-toggle"
                        ...
                        <div class="absolute w-[200px] bg-white border-2 border-[#9A9A9A] shadow-lg top-12 rounded-lg hidden"
                            id="dropdown-menu">
                            <a href="{{ route('akunOwner.create') }}" class="py-2 px-4 block hover:bg-[#E9E9E9]">
                                <p class="truncate">
                                    COA Akun
                                </p>
                            </a> --}}
                            ...
                            {{-- <a href="{{ route('karyawanOwner.create') }}" class="py-2 px-4 block hover:bg-[#E9E9E9]">
                                <p class="truncate">
                                    Karyawan
                                </p>
                            </a>
                            <a href="{{ route('proyekMdOwner.create') }}" class="py-2 px-4 block hover:bg-[#E9E9E9]">
                                <p class="truncate">
                                    Proyek
                                </p>
                            </a>
                            <a href="{{ route('supplierOwner.create') }}" class="py-2 px-4 block hover:bg-[#E9E9E9]">
                                <p class="truncate">
                                    Supplier
                                </p>
                            </a>
            ...
            <div class="flex-col pb-10 tabelMasterData hidden" id="data-asset">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('akunOwner.create') }}" class="py-2 px-4 border border-gray-500 rounded-lg hover:bg-gray-500 hover:text-white">Tambah Data +</a>
                </div>
                <div
                                ...
                                @foreach ($banks as $lancar)
                                    <tr class="bg-white">
                                        ...
                                        <td class="flex justify-center items-center gap-x-2 py-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('akunOwner.edit', $lancar->id) }}" class="btn btn-sm btn-primary">
                                            ...
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('akunOwner.destroy', $lancar->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <tbody>
                                ...
                                @foreach ($lancars as $lancar)
                                    <tr class="bg-white">
                                        ...
                                        <td class="flex justify-center items-center gap-x-2 py-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('akunOwner.edit', $lancar->id) }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($tetaps as $tetap)
                                    <tr class="bg-white">
                                        ...
                                        <td class="flex justify-center items-center gap-x-2 py-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('akunOwner.edit', $tetap->id) }}"
                                                class="btn btn-sm btn-primary">
                                                <img src="https://ar4n-group.com/public/assets/more-circle.png"
                                                    alt="edit icon" class="w-[22px] cursor-pointer">
                                            </a>
                                            ...
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('akunOwner.destroy', $tetap->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                            ...
                            <tbody>
                                ...
                                @foreach ($kewajibans as $kewajiban)
                                    <tr class="bg-white">
                                        ...
                                        <td class="flex justify-center items-center gap-x-2 py-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('akunOwner.edit', $kewajiban->id) }}"
                                                class="btn btn-sm btn-primary">
                                                <img src="https://ar4n-group.com/public/assets/more-circle.png"
                                                    alt="edit icon" class="w-[22px] cursor-pointer">
                                            </a>
                                            ...
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('akunOwner.destroy', $kewajiban->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                            ...
                            <tbody>
                                ...
                                @foreach ($ekuitass as $ekuitas)
                                    <tr class="bg-white">
                                        ...
                                        <td class="flex justify-center items-center gap-x-2 py-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('akunOwner.edit', $ekuitas->id) }}"
                                                class="btn btn-sm btn-primary">
                                                <img src="https://ar4n-group.com/public/assets/more-circle.png"
                                                    alt="edit icon" class="w-[22px] cursor-pointer">
                                            </a>
                                            ...
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('akunOwner.destroy', $ekuitas->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                            ...
                            <tbody>
                                ...
                                @foreach ($pendapatans as $pendapatan)
                                    <tr class="bg-white">
                                        ...
                                        <td class="flex justify-center items-center gap-x-2 py-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('akunOwner.edit', $pendapatan->id) }}"
                                                class="btn btn-sm btn-primary">
                                                <img src="https://ar4n-group.com/public/assets/more-circle.png"
                                                    alt="edit icon" class="w-[22px] cursor-pointer">
                                            </a>
                                            ...
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('akunOwner.destroy', $pendapatan->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                            ...
                            <tbody>
                                ...
                                @foreach ($hpps as $hpp)
                                    <tr class="bg-white">
                                        ...
                                        <td class="flex justify-center items-center gap-x-2 py-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('akunOwner.edit', $hpp->id) }}" class="btn btn-sm btn-primary">
                                                <img src="https://ar4n-group.com/public/assets/more-circle.png"
                                                    alt="edit icon" class="w-[22px] cursor-pointer">
                                            </a>
                                            <span class="border-black border-l-[1px] h-[22px]"></span>
                                            ...
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('akunOwner.destroy', $hpp->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
            ...
            <div class="flex-col pb-10 tabelMasterData hidden" id="data-karyawan">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('karyawanOwner.create') }}" class="py-2 px-4 border border-gray-500 rounded-lg hover:bg-gray-500 hover:text-white">Tambah Data +</a>
                </div>
                                ...
                                <tr class="bg-white">
                                    ...
                                    <td class="py-2">
                                        <div class="flex items-center justify-center gap-x-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('karyawanOwner.edit', $karyawan->id) }}"
                                                class="btn btn-sm btn-primary">
                                                <img src="https://ar4n-group.com/public/assets/more-circle.png"
                                                    alt="edit icon" class="w-[22px] cursor-pointer">
                                            </a>
                                            <span class="border-black border-l-[1px] h-[22px]"></span>
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('karyawanOwner.destroy', $karyawan->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
            ...
            <div class="flex-col pb-10 tabelMasterData hidden" id="data-proyek">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('proyekMdOwner.create') }}" class="py-2 px-4 border border-gray-500 rounded-lg hover:bg-gray-500 hover:text-white">Tambah Data +</a>
                </div>
                <div class="w-full flex justify-center pt-2 pb-4 shadow-[1px_1px_5px_rgba(0,0,0,0.25)] rounded-lg mt-2">
                            ...
                            @foreach ($proyeks as $proyek)
                                <tr class="bg-white">
                                    ...
                                    <td class="py-2">
                                        <div class="flex items-center justify-center gap-x-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('proyekMdOwner.edit', $proyek->id) }}"
                                                class="btn btn-sm btn-primary">
                                            ...
                                            <span class="border-black border-l-[1px] h-[22px]"></span>
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('proyekMdOwner.destroy', $proyek->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
            ...
            <div class="flex-col pb-10 tabelMasterData hidden" id="data-supplier">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('supplierOwner.create') }}" class="py-2 px-4 border border-gray-500 rounded-lg hover:bg-gray-500 hover:text-white">Tambah Data +</a>
                </div>
                <div class="w-full flex justify-center pt-2 pb-4 shadow-[1px_1px_5px_rgba(0,0,0,0.25)] rounded-lg mt-2">
                    <table class="table-fixed w-[80%] text-center">
                        <thead class="border-b-2 border-[#CCCCCC]">
                            ...
                            @foreach ($suppliers as $item)
                                <tr class="bg-white">
                                    ...
                                    <td class="py-2">
                                        <div class="flex items-center justify-center gap-x-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('supplierOwner.edit', $item->id) }}"
                                                class="btn btn-sm btn-primary">
                                                <img src="{{ asset('assets/more-circle.png') }}" alt="edit icon"
                                                    class="w-[22px] cursor-pointer">
                                            </a>
                                            <span class="border-black border-l-[1px] h-[22px]"></span>
                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('supplierOwner.destroy', $item->id) }}" method="POST"
                                                class="h-[22px]">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
