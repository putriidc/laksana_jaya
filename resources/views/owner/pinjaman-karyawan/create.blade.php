...
@section('content')
    <div class="flex flex-col items-center">
        ...
        <div class="shadow-[0px_0px_15px_rgba(0,0,0,0.25)] w-full p-10 rounded-lg bg-white">
            <form method="POST" action="" class="flex flex-col gap-y-4">
                @csrf
                <div class="flex items-center">
                    <label for="" class="w-[180px] font-medium">Tanggal</label>
                    <input type="text" data-flatpickr placeholder="Pilih Tanggal Pengajuan" name="tanggal" id=""
                        class="w-full outline-none bg-[#D9D9D9]/40 rounded-sm px-4 py-2">
                </div>
                <div class="flex items-center">
                    <label for="" class="w-[180px] font-medium">Nominal Baru</label>
                    <input type="text" name="nominal_baru" id=""
                        class="w-full outline-none bg-[#D9D9D9]/40 rounded-sm px-4 py-2">
                </div>
                <div class="flex items-center">
                ...
                <div class="flex mt-4">
                    ...
                    <div class="w-full flex gap-x-2">
                        ...
                        <button type="button" onclick="history.back()" class="bg-white border border-[#DD4049] text-[#DD4049] px-4 py-[6px] rounded-lg cursor-pointer flex items-center justify-center gap-x-2">
                            <span>Batal</span>
