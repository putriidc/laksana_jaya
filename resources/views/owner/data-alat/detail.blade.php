    ...
    <div>
        <div class="flex items-center justify-between mb-10">
            ...
            <div class="flex items-center gap-x-2 justify-center">
                <a href="{{ route('alatsOwner.edit', $alat->id) }}" class="border border-gray-600 rounded-lg py-2 px-4">Edit Alat</a>
                <form action="{{ route('alatsOwner.destroy', $alat->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
        ...
        <div class="flex justify-between items-center mb-10 max-[600px]:flex-wrap max-[600px]:gap-y-2 max-[600px]:gap-x-2">
            <div class="flex items-center gap-x-2">
                <a href="{{ route('alat-beli-owner.create.for-alat', $alat->kode_alat) }}"
                    class="block text-white bg-green-400 rounded-lg w-fit py-2 px-5">Alat Masuk</a>
                <a href="{{ route('alat-hapus-owner.create.for-alat', $alat->kode_alat) }}"
                    class="block text-white bg-green-400 rounded-lg w-fit py-2 px-5">Alat Keluar(hilang/rusak)</a>
            </div>
           <div class="flex items-center gap-x-2">
                <a href="{{ route('alat-pinjam-owner.create.for-alat', $alat->kode_alat) }}"
                    class="block text-white bg-blue-400 rounded-lg w-fit py-2 px-5">Diambil Alat</a>
                <a href="{{ route('alat-kembalikan-owner.create.for-alat', $alat->kode_alat) }}"
        ...
        <div class="border-b-2 border-[#B6B6B6] pb-8 mb-10">
            ...
            {{-- Barang Masuk --}}
            <form method="GET" action="{{ route('alatsOwner.show', $alat->id) }}" class="flex gap-x-2 mb-4 max-[600px]:flex-wrap max-[600px]:gap-y-2">
                ...
                {{-- Print Barang Masuk --}}
                <a href="{{ route('alatsOwner.printDibeli', ['id' => $alat->id, 'start_dibeli' => request('start_dibeli'), 'end_dibeli' => request('end_dibeli')]) }}"
                    target="_blank"
                            ...
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('alat-beli-owner.edit', $item->id) }}"
                                        ...
                                        {{-- Tombol Delete --}}
                                        <form action="{{ route('alat-beli-owner.destroy', $item->id) }}" method="POST"
                                            class="h-[22px]">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-beli-detail.print', ['tanggal' => $item->tanggal, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
        ...
        <div class="border-b-2 border-[#B6B6B6] pb-8 mb-10">
            ...
            <form method="GET" action="{{ route('alatsOwner.show', $alat->id) }}" class="flex gap-x-2 mb-4 max-[600px]:flex-wrap max-[600px]:gap-y-2">
                ...
                {{-- Print Barang Masuk --}}
                <a href="{{ route('alatsOwner.printDihapus', ['id' => $alat->id, 'start_dihapus' => request('start_dihapus'), 'end_dihapus' => request('end_dihapus')]) }}"
                    target="_blank"
                    class="border-[#9A9A9A] border-2 rounded-lg py-[10px] px-[10px] bg-white cursor-pointer max-[600px]:hidden">
                    <img src="{{ asset('assets/printer.png') }}" alt="printer icon" class="w-[20px]">
                </a>
                        ...
                        @foreach ($alatDihapus as $item)
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('alat-hapus-owner.edit', $item->id) }}"
                                            class="btn btn-sm btn-primary">
                                            <img src="{{ asset('assets/more-circle.png') }}" alt="edit icon"
                                                class="w-[22px] cursor-pointer">
                                        </a>
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Delete --}}
                                        <form action="{{ route('alat-hapus-owner.destroy', $item->id) }}" method="POST"
                                            class="h-[22px]">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-hapus-detail.print', ['tanggal' => $item->tanggal, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                                            <img src="{{ asset('assets/printer-oren.png') }}" alt="print icon">
                                        </a>
                                    </div>
                                </td>
        ...
        <div class="border-b-2 border-[#B6B6B6] pb-8 mb-10">
            ...
            <form method="GET" action="{{ route('alatsOwner.show', $alat->id) }}" class="flex gap-x-2 mb-4 max-[600px]:flex-wrap max-[600px]:gap-y-2">
                ...
                {{-- Print Barang Keluar --}}
                <a href="{{ route('alatsOwner.printDipinjam', ['id' => $alat->id, 'start_dipinjam' => request('start_dipinjam'), 'end_dipinjam' => request('end_dipinjam')]) }}"
                    target="_blank"
                    class="border-[#9A9A9A] border-2 rounded-lg py-[10px] px-[10px] bg-white cursor-pointer max-[600px]:hidden">
                    <img src="{{ asset('assets/printer.png') }}" alt="printer icon" class="w-[20px]">
                </a>
                        ...
                        @foreach ($alatDipinjams as $item)
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('alat-pinjam-owner.edit', $item->id) }}"
                                            class="btn btn-sm btn-primary">
                                            <img src="{{ asset('assets/more-circle.png') }}" alt="edit icon"
                                                class="w-[22px] cursor-pointer">
                                        </a>
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Delete --}}
                                        <form action="{{ route('alat-pinjam-owner.destroy', $item->id) }}" method="POST"
                                            class="h-[22px]">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-pinjam-detail.print', ['tanggal' => $item->tanggal, 'proyek' => $proyekCocok->nama_proyek, 'pic' => $proyekCocok->pic, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                                            <img src="{{ asset('assets/printer-oren.png') }}" alt="print icon">
                                        </a>
                                    </div>
                                </td>
        ...
        <div class="border-b-2 border-[#B6B6B6] pb-8 mb-10">
            ...
            <form method="GET" action="{{ route('alatsOwner.show', $alat->id) }}" class="flex gap-x-2 mb-4 max-[600px]:flex-wrap max-[600px]:gap-y-2">
                ...
                {{-- Print Barang Retur --}}
                <a href="{{ route('alatsOwner.printDikembalikan', ['id' => $alat->id, 'start_dikembalikan' => request('start_dikembalikan'), 'end_dikembalikan' => request('end_dikembalikan')]) }}"
                    target="_blank"
                    class="border-[#9A9A9A] border-2 rounded-lg py-[10px] px-[10px] bg-white cursor-pointer max-[600px]:hidden">
                    <img src="{{ asset('assets/printer.png') }}" alt="printer icon" class="w-[20px]">
                </a>
                        ...
                        @foreach ($alatDikembalikans as $item)
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('alat-kembalikan-owner.edit', $item->id) }}"
                                            class="btn btn-sm btn-primary">
                                            <img src="{{ asset('assets/more-circle.png') }}" alt="edit icon"
                                                class="w-[22px] cursor-pointer">
                                        </a>
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Delete --}}
                                        <form action="{{ route('alat-kembalikan-owner.destroy', $item->id) }}" method="POST"
                                            class="h-[22px]">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-kembali-detail.print', ['tanggal' => $item->tanggal, 'proyek' => $proyekCocok->nama_proyek, 'pic' => $proyekCocok->pic, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                                            <img src="{{ asset('assets/printer-oren.png') }}" alt="print icon">
                                        </a>
                                    </div>
                                </td>
