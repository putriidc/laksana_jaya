...
@section('content')
    <div>
        ...
        <div class="flex items-center justify-between mb-5 pb-5 border-b-[1px] border-[#CCCCCC] max-[1280px]:gap-4 max-[800px]:flex-wrap max-[800px]:justify-start">
            <div class="flex items-center gap-x-4 max-[1280px]:flex-col max-[1280px]:items-start max-[1280px]:gap-y-2">
            ...
            <div class="flex items-center gap-x-1 max-[1280px]:flex-col max-[1280px]:items-start max-[1280px]:gap-y-2">
        ...
        <div class="flex flex-col gap-y-5 mb-5">
            <div class="flex justify-between items-center gap-x-4">
                ...
                <div class="flex items-center max-[940px]:flex-col max-[940px]:items-end max-[940px]:gap-y-2">
                    {{-- Cash In Global --}}
                    <form method="GET" action="{{ route('laporanHarian.index') }}" class="flex items-center gap-x-1 max-[760px]:flex-wrap max-[760px]:justify-end max-[760px]:gap-y-2">
