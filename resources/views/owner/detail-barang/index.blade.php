...
@section('content')
    <div>
        ...
        <div class="flex gap-x-4 mb-10 max-[600px]:flex-wrap max-[600px]:gap-y-2 max-[600px]:gap-x-2">
            <a href="{{ route('barang-masuk-owner.create.for-barang', $barang->kode_barang) }}"
                class="block bg-green-400 text-white rounded-lg w-fit py-2 px-5">Barang Masuk +</a>
            <a href="{{ route('barang-keluar-owner.create.for-barang', $barang->kode_barang) }}"
                class="block bg-green-400 text-white rounded-lg w-fit py-2 px-5">Barang Keluar -</a>
            <a href="{{ route('barang-retur-owner.create.for-barang', $barang->kode_barang) }}"
        ...
        <div class="border-b-2 border-[#B6B6B6] pb-8 mb-10">
            ...
            {{-- Barang Masuk --}}
            <form method="GET" action="{{ route('barangsOwner.show', $barang->id) }}" class="flex gap-x-2 mb-4 max-[600px]:flex-wrap max-[600px]:gap-y-2">
                ...
                {{-- Print Barang Masuk --}}
                <a href="{{ route('barangsOwner.printMasuk', ['id' => $barang->id, 'start_masuk' => request('start_masuk'), 'end_masuk' => request('end_masuk')]) }}"
                    target="_blank"
                            ...
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2 max-[1100px]:pr-0">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('barang-masuk-owner.edit', $item->id) }}"
                                        ...
                                        {{-- Tombol Delete --}}
                                        <form action="{{ route('barang-masuk-owner.destroy', $item->id) }}" method="POST"
                                            class="h-[22px]">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-masuk-detail.print', ['tanggal' => $item->tanggal, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
        ...
        <div class="border-b-2 border-[#B6B6B6] pb-8 mb-10">
            ...
            <form method="GET" action="{{ route('barangsOwner.show', $barang->id) }}" class="flex gap-x-2 mb-4 max-[600px]:flex-wrap max-[600px]:gap-y-2">
                ...
                {{-- Print Barang Keluar --}}
                <a href="{{ route('barangsOwner.printKeluar', ['id' => $barang->id, 'start_keluar' => request('start_keluar'), 'end_keluar' => request('end_keluar')]) }}"
                    target="_blank"
                    class="border-[#9A9A9A] border-2 rounded-lg py-[10px] px-[10px] bg-white cursor-pointer max-[600px]:hidden">
                    <img src="{{ asset('assets/printer.png') }}" alt="printer icon" class="w-[20px]">
                </a>
                        ...
                        @foreach ($barangKeluars as $item)
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('barang-keluar-owner.edit', $item->id) }}"
                                            class="btn btn-sm btn-primary">
                                            <img src="{{ asset('assets/more-circle.png') }}" alt="edit icon"
                                                class="w-[22px] cursor-pointer">
                                        </a>
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Delete --}}
                                        <form action="{{ route('barang-keluar-owner.destroy', $item->id) }}" method="POST"
                                            class="h-[22px]">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-keluar-detail.print', ['tanggal' => $item->tanggal, 'proyek' => $proyekCocok->nama_proyek, 'pic' => $proyekCocok->pic, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                                            <img src="{{ asset('assets/printer-oren.png') }}" alt="print icon">
                                        </a>
                                    </div>
                                </td>
        ...
        <div class="border-b-2 border-[#B6B6B6] pb-8 mb-10">
            ...
            <form method="GET" action="{{ route('barangsOwner.show', $barang->id) }}" class="flex gap-x-2 mb-4 max-[600px]:flex-wrap max-[600px]:gap-y-2">
                ...
                {{-- Print Barang Retur --}}
                <a href="{{ route('barangsOwner.printRetur', ['id' => $barang->id, 'start_retur' => request('start_retur'), 'end_retur' => request('end_retur')]) }}"
                    target="_blank"
                    class="border-[#9A9A9A] border-2 rounded-lg py-[10px] px-[10px] bg-white cursor-pointer max-[600px]:hidden">
                    <img src="{{ asset('assets/printer.png') }}" alt="printer icon" class="w-[20px]">
                </a>
                        ...
                        @foreach ($barangReturs as $item)
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('barang-retur-owner.edit', $item->id) }}"
                                            class="btn btn-sm btn-primary">
                                            <img src="{{ asset('assets/more-circle.png') }}" alt="edit icon"
                                                class="w-[22px] cursor-pointer">
                                        </a>
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Delete --}}
                                        <form action="{{ route('barang-retur-owner.destroy', $item->id) }}" method="POST"
                                            class="h-[22px]">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Yakin hapus data ini?')">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-retur-detail.print', ['tanggal' => $item->tanggal, 'proyek' => $proyekCocok->nama_proyek, 'pic' => $proyekCocok->pic, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                                            <img src="{{ asset('assets/printer-oren.png') }}" alt="print icon">
                                        </a>
                                    </div>
                                </td>
