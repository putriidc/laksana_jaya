                            ...
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-beli-detail-spv.print', ['tanggal' => $item->tanggal, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                            ...
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-hapus-detail-spv.print', ['tanggal' => $item->tanggal, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                                            <img src="{{ asset('assets/printer-oren.png') }}" alt="print icon">
                                        </a>
                                    </div>
                                </td>
                            ...
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-pinjam-detail-spv.print', ['tanggal' => $item->tanggal, 'proyek' => $proyekCocok->nama_proyek, 'pic' => $proyekCocok->pic, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                                            <img src="{{ asset('assets/printer-oren.png') }}" alt="print icon">
                                        </a>
                                    </div>
                                </td>
                            ...
                            <tr class="bg-white border-b-[1px] border-[#CCCCCC]">
                                ...
                                <td class="py-2">
                                    <div class="flex justify-center items-center gap-x-2 ">
                                        ...
                                        <span class="border-black border-l-[1px] h-[22px]"></span>
                                        {{-- Tombol Print --}}
                                        <a target="_blank" href="{{ route('print-kembali-detail-spv.print', ['tanggal' => $item->tanggal, 'proyek' => $proyekCocok->nama_proyek, 'pic' => $proyekCocok->pic, 'qty' => $item->qty, 'keterangan' => $item->keterangan]) }}">
                                            <img src="{{ asset('assets/printer-oren.png') }}" alt="print icon">
                                        </a>
                                    </div>
                                </td>
