@extends('kepala-gudang.layout') @section('content')
    <div>
        ...
        <section class="flex flex-wrap gap-2">
            ...
            <div
                class="flex items-center justify-between w-[320px] h-[120px] border-[#DADADA] border-[3px] rounded-2xl py-4 pr-3 pl-1">
                <img src="{{ asset('assets/dashboard-kepala-gudang/Rectangle 107-2.png') }}" alt="gambar barang"
                    class="w-[100px]">
                <div class="flex flex-col gap-y-1">
                    <h1 class="font-bold">Meja Display Inacraft</h1>
                    <p class="text-xs">Ukuran 150 cm x 220 cm, bahan kayu kaki kaki bahan kayu.</p>
            ...
            <div
                class="flex items-center justify-between w-[320px] h-[120px] border-[#DADADA] border-[3px] rounded-2xl py-4 pr-3 pl-1">
                <img src="{{ asset('assets/dashboard-kepala-gudang/Rectangle 107-3.png') }}" alt="gambar barang"
                    class="w-[100px]">
                <div class="flex flex-col gap-y-1">
                    <h1 class="font-bold">Meja Display Inacraft</h1>
                    <p class="text-xs">Ukuran 150 cm x 220 cm, bahan kayu kaki kaki bahan kayu.</p>
            ...
            <div
                class="flex items-center justify-between w-[320px] h-[120px] border-[#DADADA] border-[3px] rounded-2xl py-4 pr-3 pl-1">
                <img src="{{ asset('assets/dashboard-kepala-gudang/Rectangle 107-4.png') }}" alt="gambar barang"
                    class="w-[100px]">
                <div class="flex flex-col gap-y-1">
                    <h1 class="font-bold">Meja Display Inacraft</h1>
                    <p class="text-xs">Ukuran 150 cm x 220 cm, bahan kayu kaki kaki bahan kayu.</p>
            ...
            <div
                class="flex items-center justify-between w-[320px] h-[120px] border-[#DADADA] border-[3px] rounded-2xl py-4 pr-3 pl-1">
                <img src="{{ asset('assets/dashboard-kepala-gudang/Rectangle 107-5.png') }}" alt="gambar barang"
                    class="w-[100px]">
                <div class="flex flex-col gap-y-1">
                    <h1 class="font-bold">Meja Display Inacraft</h1>
                    <p class="text-xs">Ukuran 150 cm x 220 cm, bahan kayu kaki kaki bahan kayu.</p>
            ...
            <div
                class="flex items-center justify-between w-[320px] h-[120px] border-[#DADADA] border-[3px] rounded-2xl py-4 pr-3 pl-1">
                <img src="{{ asset('assets/dashboard-kepala-gudang/Rectangle 107-6.png') }}" alt="gambar barang"
                    class="w-[100px]">
                <div class="flex flex-col gap-y-1">
                    <h1 class="font-bold">Meja Display Inacraft</h1>
                    <p class="text-xs">Ukuran 150 cm x 220 cm, bahan kayu kaki kaki bahan kayu.</p>
            ...
            <div
                class="flex items-center justify-between w-[320px] h-[120px] border-[#DADADA] border-[3px] rounded-2xl py-4 pr-3 pl-1">
                <img src="{{ asset('assets/dashboard-kepala-gudang/Rectangle 107-7.png') }}" alt="gambar barang"
                    class="w-[100px]">
                <div class="flex flex-col gap-y-1">
                    <h1 class="font-bold">Meja Display Inacraft</h1>
                    <p class="text-xs">Ukuran 150 cm x 220 cm, bahan kayu kaki kaki bahan kayu.</p>
            ...
            <div
                class="flex items-center justify-between w-[320px] h-[120px] border-[#DADADA] border-[3px] rounded-2xl py-4 pr-3 pl-1">
                <img src="{{ asset('assets/dashboard-kepala-gudang/Rectangle 107-8.png') }}" alt="gambar barang"
                    class="w-[100px]">
                <div class="flex flex-col gap-y-1">
                    <h1 class="font-bold">Meja Display Inacraft</h1>
                    <p class="text-xs">Ukuran 150 cm x 220 cm, bahan kayu kaki kaki bahan kayu.</p>
