...
<body class="font-poppins">
    <section class="flex h-screen">
        <nav class="flex flex-col bg-white h-screen w-[300px] py-5 px-5 shadow-[1px_0px_8px_rgba(0,0,0,0.25)] items-center relative z-[99]">
            {{-- Logo --}}
            ...
            <div class="flex flex-col gap-y-3 h-full">
                <a href="" class="cursor-pointer">
                    <button class="bg-linear-to-r from-[#DD4049] to-[#F9E52D] text-white flex items-center gap-x-5 w-[250px] py-3 px-5 rounded-lg cursor-pointer shadow-[0px_0px_15px_rgba(0,0,0,0.25)]">
                        <img src="{{ asset('assets/navbar-kepala-gudang/home-2.png') }}" alt="home icon">
                        <span>Dashboard</span>
                    </button>
                </a>
                ...
                <a href="" class="cursor-pointer">
                    <button class="bg-white text-[#353132] flex items-center gap-x-5 w-[250px] py-3 px-5 rounded-lg cursor-pointer shadow-[0px_0px_15px_rgba(0,0,0,0.25)]">
                        <img src="{{ asset('assets/navbar-kepala-gudang/3d-cube-scan.png') }}" alt="cube scan icon">
                        <span>Data Barang</span>
                    </button>
                </a>
                <a href="" class="cursor-pointer">
                    <button class="bg-white text-[#353132] flex items-center gap-x-5 w-[250px] py-3 px-5 rounded-lg cursor-pointer shadow-[0px_0px_15px_rgba(0,0,0,0.25)]">
                        <img src="{{ asset('assets/navbar-kepala-gudang/convert-3d-cube.png') }}" alt="convert 3d cube icon">
        ...
        <div class="w-full flex flex-col relative">
            ...
            <header class="flex justify-between items-center px-10 py-4 shadow-[0px_1px_8px_rgba(0,0,0,0.25)]">
                ...
                <div class="flex items-center gap-x-4">
                    <img src="{{ asset('assets/notification.png') }}" alt="notification icon" class="w-[30px] cursor-pointer">
                    <div class="flex items-center gap-x-2">
                        <img src="{{ asset('assets/Ellipse 1.png') }}" alt="profile picture" class="w-[40px] h-[40px]">
            ...
            <footer class="absolute bottom-0 z-50 flex justify-center w-full py-3 shadow-[0px_-1px_8px_rgba(0,0,0,0.25)] bg-white">
    ...
    <script>
        ...
        link.forEach((item, index) => {
            ...
            if(sidebar == index){
                item.classList.add('bg-linear-to-r', 'from-[#DD4049]', 'to-[#F9E52D]', 'text-white');
            } else {
                item.classList.remove('bg-linear-to-r', 'from-[#DD4049]', 'to-[#F9E52D]', 'text-white');
            }
        });
    </script>
</body>
